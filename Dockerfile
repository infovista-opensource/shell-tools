...
--output-document=/tmp/helm-v4.0.4-linux-amd64.tar.gz \
&& mkdir /tmp/helm && tar -xvf /tmp/helm-v4.0.4-linux-amd64.tar.gz -C /tmp/helm \
&& mv /tmp/helm/linux-amd64/helm /usr/local/bin/helm-v4.0.4 \
&& rm -rf /tmp/helm /tmp/helm-v4.0.4-linux-amd64.tar.gz \
&& wget https://dl.k8s.io/release/v1.35.0/bin/linux/amd64/kubectl  \
--output-document=/usr/local/bin/kubectl-v1.35.0 \
...
&& chmod +x /usr/local/bin/helm-v4.0.4 \
&& ln -s /usr/local/bin/helm-v4.0.4 /usr/local/bin/helm \
&& chmod +x /usr/local/bin/kubectl-v1.35.0 \
&& ln -s /usr/local/bin/kubectl-v1.35.0 /usr/local/bin/kubectl \
