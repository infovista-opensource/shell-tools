...
--output-document=/tmp/helm-v4.1.1-linux-amd64.tar.gz \
&& mkdir /tmp/helm && tar -xvf /tmp/helm-v4.1.1-linux-amd64.tar.gz -C /tmp/helm \
&& mv /tmp/helm/linux-amd64/helm /usr/local/bin/helm-v4.1.1 \
&& rm -rf /tmp/helm /tmp/helm-v4.1.1-linux-amd64.tar.gz \
&& wget https://dl.k8s.io/release/v1.36.0/bin/linux/amd64/kubectl  \
--output-document=/usr/local/bin/kubectl-v1.36.0 \
...
&& chmod +x /usr/local/bin/helm-v4.1.1 \
&& ln -s /usr/local/bin/helm-v4.1.1 /usr/local/bin/helm \
&& chmod +x /usr/local/bin/kubectl-v1.36.0 \
&& ln -s /usr/local/bin/kubectl-v1.36.0 /usr/local/bin/kubectl \
